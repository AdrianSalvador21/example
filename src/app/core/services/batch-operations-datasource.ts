...
export class BatchDataSource implements DataSource<BenefOperation> {
  ...
  loadOperations(operationGroup, currentUser, creatorUser: string, clientID: string, dateFrom: Moment, dateTo: Moment, status: string, folio, cantSignatures, pageNumber = 1, pageSize = 10) {
